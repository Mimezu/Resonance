...
P("devourer_dh_void_ray",   C(true, 568889, 0), C(true, 568889, 0, 5342340, 75), C(true, 568889, 0, 5342340, 65))
...
P("audit12_devourer_reap",  C(false, 5917414, 0), C(false, 5917414, 0), C(true, 5917414, 0, 568889, 50))
P("audit12_devourer_consume", C(false, 7569671, 0), C(true, 7569671, 0), C(true, 7569671, 0, 5342340, 75))
P("audit12_devourer_soul_immolation", C(true, 5342340, 0), C(true, 5342340, 0, 568889, 75), C(true, 5342340, 0, 568889, 60))
P("audit12_devourer_voidblade", C(false, 5917414, 0), C(false, 5917414, 0), C(true, 5917414, 0, 568889, 50))
...
P("audit12_devourer_cull",  C(false, 5917414, 0), C(false, 5917414, 0), C(true, 5917414, 0, 568889, 50))
P("audit12_devourer_reapers_toll", C(false, 6908644, 0), C(false, 6908644, 0), C(true, 6908644, 0, 568751, 65))
P("audit12_devourer_pierce_veil", C(false, 5917414, 0), C(false, 5917414, 0), C(true, 5917414, 0, 568889, 50))
P("audit12_devourer_predator_wake", C(true, 6908118, 0), C(true, 6908118, 0, 5342340, 75), C(true, 6908118, 0, 568889, 70))

...
local rules = {
    ...
    { id="mm_deadly_insight", spec=254, spell="Deadly Insight", moment="Ready", event="AURA", auraIDs={1277136}, capability="deadlyInsight", preset="subtle", cooldown=3, defaultOn=true, defaultSounds={5259954,1591768}, defaultDelays={0,80}, description="Apex: sounds only when the Rapid Fire enhancement is newly gained." },
    ...
    { id="assa_deathstalkers_mark", spec=259, spell="Deathstalker's Mark", moment="Marked", event="AURA", auraIDs={457052}, capability="deathstalker", preset="medium", cooldown=2, defaultOn=true, defaultSounds={568406,1315153}, defaultDelays={0,75}, description="Deathstalker only: sounds when the shadow mark is newly applied." },
    { id="assa_implacable", spec=259, spell="Implacable", moment="Chain falloff", event="AURA", auraIDs={1265385,1265386,1265387}, capability="implacable", preset="subtle", cooldown=4, defaultOn=true, defaultSounds={1301161,568984}, defaultDelays={55,145}, description="Apex: cue the live Implacable chain-falloff aura variants, never Kingsbane itself." },
    ...
    { id="outlaw_pistol_shot", spec=260, spell="Pistol Shot", moment="Proc shot", event="SUCCEEDED", spellIDs={185763}, preset="expressive", cooldown=1.5, defaultOn=false, defaultSounds={1360714,1537119}, defaultDelays={0,55}, description="Optional Opportunity/Fan the Hammer shot; disabled by default." },
    ...
    { id="sub_deathstalkers_mark", spec=261, spell="Deathstalker's Mark", moment="Marked", event="AURA", auraIDs={457052}, capability="deathstalker", preset="medium", cooldown=2, defaultOn=true, defaultSounds={568406,1315153}, defaultDelays={0,75}, description="Deathstalker only: sounds when the shadow mark is newly applied." },
    { id="sub_ancient_arts", spec=261, spell="Ancient Arts", moment="Ready", event="AURA_STACK", auraIDs={1268932,1268936,1268939}, capability="ancientArts", stackThreshold=5, preset="subtle", cooldown=3, defaultOn=true, defaultSounds={5259954,1315156}, defaultDelays={0,100}, description="Apex: current Ancient Arts aura variants at five stored stacks." },
    ...
    { id="arms_master_of_warfare", spec=71, spell="Master of Warfare", moment="Empowered", event="AURA", auraIDs={1269394}, capability="masterOfWarfare", preset="subtle", cooldown=3, defaultOn=true, defaultSounds={4548276,5259954}, defaultDelays={0,95}, description="Apex: the verified armor-penetration buff, not every Heroic Strike replacement." },
    ...
    { id="arms_overpower", spec=71, spell="Overpower", moment="Proc strike", event="SUCCEEDED", spellIDs={7384}, preset="expressive", cooldown=1.2, defaultOn=false, defaultSounds={4553587}, description="Optional frequent proc strike; disabled by default and throttled." },
    ...
    { id="fury_rampaging_berserker", spec=72, spell="Rampaging Berserker", moment="Berserk", event="SUCCEEDED", spellIDs={1719}, capability="rampagingBerserker", preset="subtle", cooldown=4, defaultOn=true, defaultSounds={4543791,4556846}, defaultDelays={55,135}, description="Apex: a short storm tail when Recklessness grants Berserk stacks." },
    ...
    { id="fury_raging_blow", spec=72, spell="Raging Blow", moment="Proc strike", event="SUCCEEDED", spellIDs={85288}, preset="expressive", cooldown=1.2, defaultOn=false, defaultSounds={4556846}, description="Optional frequent proc strike; disabled by default and throttled." },
    ...
    { id="prot_revenge", spec=73, spell="Revenge", moment="Proc strike", event="SUCCEEDED", spellIDs={6572}, preset="expressive", cooldown=1.5, defaultOn=false, defaultSounds={4553587}, description="Optional frequent proc strike; disabled by default and throttled." },

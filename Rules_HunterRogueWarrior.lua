...
local rules = {
    ...
    { id="mm_aimed_shot", spec=254, spell="Aimed Shot", moment="Cast", event="SUCCEEDED", spellIDs={19434}, preset="medium", cooldown=1.2, defaultOn=true, defaultSounds={1590095,1313130}, defaultDelays={0,85}, description="The current 2.5-second precision cast; its generated Casting option is intentional." },
    ...
    { id="mm_wailing_arrow", spec=254, spell="Wailing Arrow", moment="Cast", event="SUCCEEDED", spellIDs={355839,355596,357616,459805,459808}, capability="darkRanger", preset="medium", cooldown=2, defaultOn=true, defaultSounds={1594748,1594754}, defaultDelays={0,90}, description="Dark Ranger Wailing Arrow player-cast variants." },

    -- Survival Hunter: bombs and coordinated animal attacks, with a single Apex
    -- accent for the Raptor Strike replacement.
    { id="sv_wildfire_bomb", spec=255, spell="Wildfire Bomb", moment="Cast", event="SUCCEEDED", spellIDs={259495}, preset="medium", cooldown=1.2, defaultOn=true, defaultSounds={2145570,2145572}, defaultDelays={0,90}, description="A fire-and-pheromone accent for the alchemical bomb, never its periodic damage." },
    ...
    { id="sv_boomstick", spec=255, spell="Boomstick", moment="Cast", event="SUCCEEDED", spellIDs={1261215}, preset="medium", cooldown=1.5, defaultOn=true, defaultSounds={2145570,1603347}, defaultDelays={0,75}, description="Current 12.1 Survival rotational explosive button." },
    ...
    { id="assa_envenom", spec=259, spell="Envenom", moment="Cast", event="SUCCEEDED", spellIDs={32645}, preset="medium", cooldown=1.2, defaultOn=true, defaultSounds={1301161,1301162}, defaultDelays={0,70}, description="Poison magic cast accent; its normal weapon contact remains untouched." },
    ...
    { id="sub_secret_technique", spec=261, spell="Secret Technique", moment="Cast", event="SUCCEEDED", spellIDs={280719}, preset="medium", cooldown=2, defaultOn=true, defaultSounds={1305797,568984}, defaultDelays={0,85}, description="A single shadow-clone cast accent." },
    ...
    { id="arms_mortal_strike", spec=71, spell="Mortal Strike", moment="Cast", event="SUCCEEDED", spellIDs={12294}, preset="medium", cooldown=1.0, defaultOn=true, defaultSounds={4553587}, description="Core Arms identity spender; one restrained weapon cast cue." },
    ...
    { id="arms_bladestorm", spec=71, spell="Bladestorm", moment="Cast", event="SUCCEEDED", spellIDs={227847}, preset="subtle", cooldown=3, defaultOn=true, defaultSounds={4543791,4553587}, description="Instant Arms burst cast; this is not a cast-bar event." },
    ...
    { id="fury_bladestorm", spec=72, spell="Bladestorm", moment="Cast", event="SUCCEEDED", spellIDs={227847}, preset="subtle", cooldown=3, defaultOn=true, defaultSounds={4543791,4553587}, description="Instant Fury burst cast; this is not a cast-bar event." },
    { id="fury_odyns_fury", spec=72, spell="Odyn's Fury", moment="Cast", event="SUCCEEDED", spellIDs={385059}, preset="subtle", cooldown=3, defaultOn=true, defaultSounds={4543791,4553587}, description="Major Fury elemental burst cast." },

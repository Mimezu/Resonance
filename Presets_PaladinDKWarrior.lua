...
Curate("holy_pal_dawnlight",        {5207969,5205686}, {0,100}, false, true,  true,  nil)
Curate("holy_pal_armaments",        {5207969},         {0},     false, true,  true,  PALADIN_TAIL)
...
Curate("prot_pal_armaments",              {5207969},         {0},     false, true,  true,  PALADIN_TAIL)
...
Curate("ret_pal_dawnlight",          {5207969,5205686}, {0,100}, false, true,  true,  nil)
...
Curate("arms_master_of_warfare", {4548276,4548280}, {0,95},  false, true,  true,  4556549)
...
Curate("fury_rampaging_berserker", {4543791,4556846}, {55,135},false, true,  true,  WARRIOR_TAIL)

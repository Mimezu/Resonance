...
local rules = {
    ...
    { id="arcane_pulse_12_1", spec=62, spell="Arcane Pulse", moment="Release", event="SUCCEEDED", spellIDs={1241462}, preset="medium", cooldown=1.2, defaultOn=true,
    ...
    { id="frost_flurry_12_1", spec=64, spell="Flurry", moment="Release", event="SUCCEEDED", spellIDs={44614}, preset="expressive", cooldown=1.1, defaultOn=false,
      defaultSounds={4612975}, defaultDelays={0}, description="Optional Brain Freeze shatter setup accent." },
    { id="frost_ice_lance_12_1", spec=64, spell="Ice Lance", moment="Release", event="SUCCEEDED", spellIDs={30455}, preset="expressive", cooldown=0.8, defaultOn=false,
      defaultSounds={4613005}, defaultDelays={0}, description="Optional Fingers of Frost spender accent." },
    { id="frost_comet_storm_12_1", spec=64, spell="Comet Storm", moment="Release", event="SUCCEEDED", spellIDs={1247777}, preset="medium", cooldown=1.2, defaultOn=true,
